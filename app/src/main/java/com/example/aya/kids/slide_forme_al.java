...
public class slide_forme_al extends  PagerAdapter {
    ...
    public slide_forme_al(Context context) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = inflater.inflate(R.layout.slide_forme_al,container,false);
